...
namespace PPTReport
{
    public static class StringExtensions
    {
        ...
        public static (String sourceConnection, String templateConnection) ParseArguments(this string[] args)
        {
            return args is null ? ((String sourceConnection, String templateConnection))(null, null) : (args[0], args[1]);
        }
        ...
        public static (bool argsAreValid, IEnumerable<string> argumentErrors) ValidateArguments(this string[] args)
        {
            ...
            if ((args is null) || (args.Length != expectedArgCount))
                errors.Add("Usage - PPTReport.exe SourceConnectionString TemplateConnectionString");
            else
            {
                ...
                if (string.IsNullOrEmpty(args[1]))
                    errors.Add("A value must be supplied for the TemplateConnectionString argument");
            }
